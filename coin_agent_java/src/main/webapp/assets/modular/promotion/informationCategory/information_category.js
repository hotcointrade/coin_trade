layui.use(['layer', 'form', 'table', 'admin', 'ax'], function () {
     ...
     */
    var Notice = {
        tableId: "informationCategoryTable"    //表格id
    };
    ...
    Notice.openAddNotice = function () {
        ...
        top.layui.admin.open({
            type: 2,
            title: '添加',
            content: Feng.ctxPath + '/informationCategory/information_category_add',
            end: function () {
    ...
    Notice.onEditNotice = function (data) {
        ...
        top.layui.admin.open({
            type: 2,
            title: '编辑',
            content: Feng.ctxPath + '/informationCategory/information_category_edit/' + data.id,
            end: function () {
                admin.getTempData('formOk') && table.reload(Notice.tableId);
            }
        });
    ...
    Notice.onDeleteNotice = function (data) {
        var operation = function () {
            var ajax = new $ax(Feng.ctxPath + "/informationCategory/delete", function (data) {
                Feng.success("删除成功!");
    ...
    var tableResult = table.render({
        elem: '#' + Notice.tableId,
        url: Feng.ctxPath + '/informationCategory/list',
        page: true,
        height: "full-158",
        cellMinWidth: 100,
