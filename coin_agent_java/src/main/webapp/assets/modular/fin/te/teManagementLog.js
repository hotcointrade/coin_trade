layui.use(['table', 'admin', 'ax', 'ztree','laydate','form'], function () {
     ...
     */
    var Obj = {
        tableId: "teManagementLogTable",	//表格id
        condition: {
            id: ""
            ,timeLimit:""
        }
    ...
    Obj.initColumn = function () {
        return [[
			...
			{field: 'id', hide: true, sort: true, title: 'id'},
							...
							{field: 'instrument', sort: true, title: '认筹标题',minWidth: 90},
							{field: 'earningsSum', sort: true, title: '收益数量',minWidth: 90},
							 {field: 'managementCurrency', sort: true, title: '收益币种',minWidth: 90},
							// {field: 'managementSum', sort: true, title: '目标币数量',minWidth: 90},
							// {field: 'salesmanId', sort: true, title: '业务员',minWidth: 90},
    ...
    var apiPrefix="teManagementLog";//api
    /**
     * 修改状态
     *
     * @param contactId id
    ...
    Obj.openDetail = function () {
        if (this.check()) {
            var index = layer.open({
                ...
                fix: false, //不固定
                maxmin: true,
                content: Feng.ctxPath + "/"+apiPrefix+'/teManagementLog_edit/' + Obj.seItem.id
            });
        ...
        Feng.confirm("是否删除理财认购记录 ?", operation);
    };
        ...
        Obj.openAdd = function () {
            ...
            top.layui.admin.open({
                ...
                title: '添加理财认购记录账户',
                area:["800px","420px"],
                content: Feng.ctxPath + "/"+apiPrefix+'/teManagementLog_add',
                end: function () {
         ...
         */
         Obj.onEdit = function (data) {
            ...
            top.layui.admin.open({
                ...
                title: '修改理财认购记录',
                area:["800px","420px"],
                content: Feng.ctxPath + "/"+apiPrefix+'/teManagementLog_edit?id=' + data.id,
                end: function () {
                    admin.getTempData('formOk') && table.reload(Obj.tableId);
                }
            });
