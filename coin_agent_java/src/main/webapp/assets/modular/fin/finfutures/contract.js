...
Contract.initColumn = function () {
    return [[
        ...
        {field: 'rate',hide: true,  sort: true, title: '保证金率'},
        {field: 'type', sort: true, title: '类型'},
        {field: 'usedPrice', sort: true, title: '合约权益资产'},
...
Contract.openContractDetail = function () {
    if (this.check()) {
        var index = layer.open({
            ...
            fix: false, //不固定
            maxmin: true,
            content: Feng.ctxPath + '/finFutures/contract_edit/' + Contract.seItem.id
        });
    ...
    Contract.onDeleteContract = function (data) {
        var operation = function () {
            var ajax = new $ax(Feng.ctxPath + "/finFutures/delete", function () {
                Feng.success("删除成功!");
    ...
    Contract.openAddContract = function () {
        ...
        top.layui.admin.open({
            ...
            title: '添加合约账户',
            area:["800px","420px"],
            content: Feng.ctxPath + '/finFutures/contract_add',
            end: function () {
     ...
     */
     Contract.onEditContract = function (data) {
        ...
        top.layui.admin.open({
            ...
            title: '修改合约账户',
            area:["800px","420px"],
            content: Feng.ctxPath + '/finFutures/contract_edit?contractId=' + data.contractId,
            end: function () {
                admin.getTempData('formOk') && table.reload(Contract.tableId);
            }
        });
 ...
 // 渲染表格
    var tableResult = table.render({
        ...
        url: Feng.ctxPath + '/finFutures/list',
        page: true,
        height: "full-158",
        cellMinWidth: 100,
        limit:100,
