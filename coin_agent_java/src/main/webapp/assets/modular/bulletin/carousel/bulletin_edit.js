layui.use(['layer', 'form', 'admin', 'ax', 'layedit','upload'], function () {
    var $ = layui.jquery;
    var $ax = layui.ax;
    var form = layui.form;
    ...
    //获取信息
    var ajax = new $ax(Feng.ctxPath + "/bulletin/detail/" + Feng.getUrlParam("carouselId"));
    ...
    form.on('submit(btnSubmit)', function (data) {
        var ajax = new $ax(Feng.ctxPath + "/bulletin/edit", function (data) {
            Feng.success("修改成功！");
