layui.use(['table', 'admin', 'ax', 'ztree'], function () {
    ...
    Config.openAddConfig = function () {
        ...
        top.layui.admin.open({
            ...
            title: '添加参数',
            area:["450px","400px"],
            content: Feng.ctxPath + '/contract_option_config/config_add',
            end: function () {
    ...
    Config.onEditConfig = function (data) {
        ...
        top.layui.admin.open({
            ...
            title: '修改参数',
            area:["450px","400px"],
            content: Feng.ctxPath + '/contract_option_config/config_edit?configId=' + data.configId,
            end: function () {
                admin.getTempData('formOk') && table.reload(Config.tableId);
            }
        });
    ...
    Config.onDeleteConfig = function (data) {
        var operation = function () {
            var ajax = new $ax(Feng.ctxPath + "/contract_option_config/delete", function () {
                Feng.success("删除成功!");
    ...
    var tableResult = table.render({
        elem: '#' + Config.tableId,
        url: Feng.ctxPath + '/contract_option_config/list',
        page: true,
        height: "full-158",
        cellMinWidth: 100,
        limit:100,
