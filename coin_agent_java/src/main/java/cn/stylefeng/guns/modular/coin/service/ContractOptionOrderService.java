...
public  class ContractOptionOrderService extends ServiceImpl<ContractOptionOrderMapper, ContractOptionOrder>{
    ...
    */
     ...
     * 查询期权交易对
     */
    public Page<Map<String,Object>> selectByCondition2( String symbol, Long memberId, String recommendIds,BigDecimal betAmount, BigDecimal rewardAmount) {
        Page page = LayuiPageFactory.defaultPage();
        return this.baseMapper.selectByCondition2(page, symbol, memberId,recommendIds, betAmount, rewardAmount);
    }
