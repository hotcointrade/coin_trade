...
public class CompactController extends BaseController {
    ...
    private String PREFIX = "/modular/e/compact/";
    ...
    public String index(Model model) {
        ...
        mapQ.put("memberId",memberId);
        mapQ.put("recommendIds",recommendIds);
        Map<String, Object> map = compactService.getTotalMap(mapQ);
    ...
    public String compactEdit(Long compactId, Model model) {
        Compact condition = this.compactService.getById(compactId);
    ...
    public Object detail(@PathVariable("compactId") Long compactId) {
        Compact entity = compactService.getById(compactId);
    ...
    @ResponseBody
    public ResponseData edit(Compact compact) {
    ...
    @ResponseBody
    public ResponseData add(Compact compact, BindingResult result) {
        if (result.hasErrors()) {
    ...
    public Object content(@PathVariable("compactId") Long id) {
        Compact compact = compactService.getById(id);
