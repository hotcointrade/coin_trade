 ...
 */
public class CurrencyWrapper extends BaseControllerWrapper{

    public CurrencyWrapper(Map<String, Object> single) {
            super(single);
        }

        public CurrencyWrapper(List<Map<String, Object>> multi) {
            super(multi);
        }

        public CurrencyWrapper(Page<Map<String, Object>> page) {
            super(page);
        }

        public CurrencyWrapper(PageResult<Map<String, Object>> pageResult) {
            super(pageResult);
        }
