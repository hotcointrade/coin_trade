...
//@Component
public class HuobiSocketClientSwap
{
...
//        try
//        {
//            URI uri = new URI("wss://api.btcgateway.pro/swap-ws");
//            new Thread(() ->
//            {
//                while (true)
//                {
...
//                    {
//                        Thread.sleep(60000);
//                        WebSocketcSwap ws = new WebSocketcSwap(uri);
//                        client.connect(ws);
//
//                        WebSocketDepthSwap wsD = new WebSocketDepthSwap(uri);
//                        client.connect(wsD);
//
...
// * k线 及实时行情
// */
//class WebSocketcSwap extends WebSocketClient
//{
//
//
//    public static String KLINE = "market.%s.kline.%s";
//    public static String DEPTH = "market.%s.depth.step1";
//    private static final Logger logger = LoggerFactory.getLogger(WebSocketcSwap.class);
//    private BigDecimal cnyUsdt;
//
//    public WebSocketcSwap(URI uri)
//    {
...
//    {
//
//        for (ProConst.ContractKlineType klineType : ProConst.ContractKlineType.values())
//        {
//
//            String symbols = klineType.contract;
...
//            {
//                String topic = String.format(KLINE, symbols, periodType.code);
...
//
//                        String key = Constant.KINE_PERPETUAL + symbol + "_" + time;
...
// * 深度
// */
//class WebSocketDepthSwap extends WebSocketClient
//{
//
//
//    //    public static String KLINE = "market.%s.kline.%s";
...
//    private BigDecimal cnyUsdt;
//
//    public WebSocketDepthSwap(URI uri)
//    {
//        super(uri, new Draft_6455());
//        this.uri = uri;
////        this.cnyUsdt = (BigDecimal) cny;
...
////            String[] symbol = symbols.split("/");
////            String currency = symbol[0].toLowerCase() + symbol[1].toLowerCase();
//            String depth = String.format(DEPTH, symbols);
//            sendWsDepth("sub", depth);
//        }
//
//
...
//                        String key = Constant.DEPTH_PERPETUAL + symbol;
//
