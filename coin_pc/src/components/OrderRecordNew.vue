<template>
    <div class="contract_record_div">
        ...
        <!-- 设置止盈止损弹窗 -->
        <el-dialog :visible.sync="setProfit" :close-on-click-modal="false" :before-close="setAverageCancel" width="30%"
        ...
        <!-- 确认平仓弹窗 -->
        <el-dialog :visible.sync="sureAverage" :close-on-click-modal="false" :before-close="closeCancel" width="30%"
...
export default {
    ...
    methods: {
        ...
        async setAverageFun() {//确认平仓
            ...
            if (Number(that.form.closeNum) <= 0) {
