	...
	<div class="home_div">
		<main class="home-container">
			<div class="home-main">
				<section class="home-top">
						...
						<div class="okg-container">
							<div class="main-container">
								<div class="home-text-box" id="homeTextBox">
									<div class="home-title" data-lang-key="home_banner_title1">{{ $t("home.huobi18") }}
									</div>
									<div class="home-title" data-lang-key="home_banner_title1"></div>
									<h1 class="home-subtitle" data-lang-key="home_banner_subtitle">
										{{ $t('home.huobi20') }}</h1>
								</div>
								<!-- 注册条 -->
								<div class="buy-coin-box" id="buyCoinBox">
									<div class="buy-input-box" id="buyInputBox">
										<input type="text" name="" id="buyAmount" class="buy-input"
											:placeholder="$t('home.huobi40')" autocomplete="off">
									</div>
									<button class="buy-coin-btn" id="buyCoinBtn"
										@click="jumpRegister">{{ $t("home.onceRe") }}</button>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="block"
						style="position: relative;right: 0px;left: 224px;text-align: center;border-radius: 30px;top: -148px;width: 1000px;height: 280px;">
		...
		<div class="container" style="width: 70%;">
			...
			<div class="ainer_maer">
				<div>
					<div
						class="el-table table el-table--fit el-table--enable-row-hover el-table--enable-row-transition">
						<el-table border stripe :data="tableData" @row-click="detailFun" style="width: 100%;">
							...
							<el-table-column align="center" prop="open" :label="$t('home.huobi11')">
								<template slot-scope="scope">
									<span style="font-weight: 700; font-size: 14px">{{ scope.row.open }}
										<span style="font-weight: 400; color: #673AB7; font-size: 12px">
			...
			<div class="new_appDownload_container">
				...
				<div class="new_appDownload_link">
					<div class="new_appDownload_link_title">
						<span class="one"
							style="font-size: 20px;line-height: 30px; font-weight: 700">{{ $t("home.huobi16") }}</span>
					</div>
					<div class="new_appDownload_link_title">
						<br />
		...
		<div class="new_registered">
			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="100%"
				height="300">
				<g fill="rgba(157,119,255,0.5)" transform="translate(-976.065 0)">
					<path
				...
				<g fill="rgba(157,119,255,0.3)" transform="translate(-1561.7 0)">
					<path
			...
			<div class="new_registered_input">
				...
				<span><button class="buy-coin-btn" id="buyCoinBtn" @click="jumpRegister">{{ $t("home.onceRe")
						}}</button></span>
			</div>
		</div>
		<Foot />
...
export default {
	...
	created() {
		...
		noticeApi(dataArr).then((r) => {
			this.noticeArr = r.data.records.slice(0, 5); //控制公告仅显示4条
		});
	...
	beforeDestroy() {
		this.backgroundColor = "#171b2b";
		this.background = "#171b2b";
