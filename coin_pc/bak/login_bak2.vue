    ...
    <div class="all_container">
        <div >
            <section id="container">
                <div class="sign-page bg-img" id="contBox" style="padding-top: 70px; padding-bottom: 90px; background: rgb(29, 29, 60); min-height: 985px;">
                    <div class="cont-center">
                            ...
                            <el-form :model="form" ref="form">
                                ...
                                <div>
                                    <p class="fontCenter moveHand ppip"><a class="themeFont" @click="dialogForget">{{$t('form.forget')}}</a><a class="themeFont" @click="$router.push('/register')">{{$t('verification.registerName')}}</a></p>
                                </div>
                ...
                <div class="miniFooter">
                    ...
                    <span class="f">© 2010-2022 Hot Coin Trade.sh ALL Rights Reserved.</span>
                </div>
