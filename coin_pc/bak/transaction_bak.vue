                    ...
                    <div class="transaction_left">
                        ...
                        <div class="leftBzList"
                            ...
                            <div v-for="item in coinArr" :key="item.symbol"
                                ...
                                <div style="width:250px;padding: 8px 8px;text-align:center">

                                    <!-- {{ item.symbol ==
                                    form.region ? newPirce : item.close }}
                                     -->
                                    {{ item.close }} 
                                </div>
                                <div style="width:100px;padding: 8px 8px;text-align:center"
                                    :class="item.rose > 0 ? 'green' : 'red'">{{ item.rose > 0 ? '+' : '' }}{{
                                        (item.rose).toFixed(2) }}%
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="transaction_right_div">
                                    ...
                                    <div class="priceBox">
                                        <div class="betweenSpread">
                                            ...
                                            <span style="color:#fff">{{ $t('transaction.firstPrice') }}{{ hands }}{{ getCoin
                                            }}</span>
                                        </div>
                                    ...
                                    <div class="lastBtn" v-if="token">
                                        <el-button class="buyBtn" @click="submitFun('BUY')" type="button">{{
                                            $t('transaction.buy') }}</el-button>
                                        <el-button class="sellBtn" @click="submitFun('SELL')" type="button">{{
                                            $t('transaction.sell') }}</el-button>
                                    </div>
                        ...
                        <div class="picture" style="width: 73%;float: right;">
                            <TradeView :nowPrice="newPirce" :symbolValue="form.region" :type="1"
                ...
                <div class="grid-content transaction_right">
                    <div class="entrustList">
                        <h3>
                            ...
                            <span @click="changEnOrReList(false)" style="margin-left: 15px">{{
                                $t('transaction.realTimeList') }}</span>
                        </h3>
...
import { ticketApi, tradeListApi, contractPageApi, contractApi, realListApi } from '@/api/getData'
