layui.use(['table', 'admin', 'ax', 'ztree','laydate','form'], function () {
     ...
     */
    var Obj = {
        tableId: "contractGoldTable",	//表格id
        condition: {
            id: ""
            ,timeLimit:""
        }
    ...
    var apiPrefix="contractGold";//api
    /**
     * 修改状态
     *
     * @param contactId id
    ...
    Obj.openDetail = function () {
        if (this.check()) {
            var index = layer.open({
                ...
                fix: false, //不固定
                maxmin: true,
                content: Feng.ctxPath + "/"+apiPrefix+'/contractGold_edit/' + Obj.seItem.id
            });
        ...
        Obj.onDelete = function (data) {
            ...
            Feng.confirm("是否删除黄金交易每一期 ?", operation);
        };
        ...
        Obj.openAdd = function () {
            ...
            top.layui.admin.open({
                ...
                title: '添加黄金交易每一期账户',
                area:["800px","420px"],
                content: Feng.ctxPath + "/"+apiPrefix+'/contractGold_add',
                end: function () {
         ...
         */
         Obj.onEdit = function (data) {
            ...
            top.layui.admin.open({
                ...
                title: '修改黄金交易每一期',
                area:["800px","420px"],
                content: Feng.ctxPath + "/"+apiPrefix+'/contractGold_edit?id=' + data.id,
                end: function () {
                    admin.getTempData('formOk') && table.reload(Obj.tableId);
                }
            });
