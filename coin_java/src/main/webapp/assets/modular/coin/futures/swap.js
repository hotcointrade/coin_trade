layui.use(['table', 'admin', 'ax', 'ztree','laydate','form'], function () {
    ...
    Obj.initColumn = function () {
        return [[
            // {type: 'checkbox'},
             {field: 'futuresId', hide: true, sort: true, title: 'id'},
...
/*             {field: 'spread', sort: true, title: '点差'},*/
        ...
        Obj.search = function () {
            ...
            queryData['swapId'] = Obj.condition.futuresId;
            queryData['timeLimit'] = $("#timeLimit").val();
            table.reload(Obj.tableId, {where: queryData});
        };

    var apiPrefix="futures";//api
    /**
     * 修改状态
     *
     * @param contactId id
    ...
    Obj.openSwapDetail = function () {
        if (this.check()) {
            var index = layer.open({
                ...
                fix: false, //不固定
                maxmin: true,
                content: Feng.ctxPath  + "/"+apiPrefix+'/swap_edit/' + Obj.seItem.id
            });
        ...
        Obj.onDeleteSwap = function (data) {
            var operation = function () {
                ...
                ajax.set("swapId", data.futuresId);
                ajax.start();
            };
        ...
        Obj.openAddSwap = function () {
            ...
            top.layui.admin.open({
                ...
                title: '添加合约交易对',
                area:["800px","420px"],
                content: Feng.ctxPath + "/"+apiPrefix+'/swap_add',
                end: function () {
         ...
         */
         Obj.onEditSwap = function (data) {
            ...
            top.layui.admin.open({
                ...
                title: '修改合约交易对',
                area:["800px","420px"],
                content: Feng.ctxPath + "/"+apiPrefix+'/swap_edit?swapId=' + data.futuresId,
                end: function () {
                    admin.getTempData('formOk') && table.reload(Obj.tableId);
                }
            });
