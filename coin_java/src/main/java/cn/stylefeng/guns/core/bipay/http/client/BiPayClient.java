...
import cn.stylefeng.guns.core.bipay.constant.API;
...
import cn.stylefeng.guns.core.bipay.entity.Transfer;
import cn.stylefeng.guns.core.bipay.http.ResponseMessage;
import cn.stylefeng.guns.core.bipay.utils.HttpUtil;
...
public class BiPayClient implements Client<String> {
     ...
     * @throws Exception
     */
    public ResponseMessage<Address> createCoinAddress(String mainCoinType, String alias, String walletId) throws Exception {
     ...
     * @throws Exception
     */
    public ResponseMessage<List<Address>> createBatchCoinAddress(String mainCoinType, int count) throws Exception {
        JSONArray body = new JSONArray();
        JSONObject item = new JSONObject();
        item.put("merchantId", this.merchantId);
        item.put("coinType", mainCoinType);
     ...
     * @throws Exception
     */
    public ResponseMessage<String> transfer(String orderId, BigDecimal amount, String mainCoinType, String subCoinType, String address, String memo) throws Exception {
     ...
     * @throws Exception
     */
    public ResponseMessage<String> autoTransfer(String orderId, BigDecimal amount, String mainCoinType, String subCoinType, String address,  String memo) throws Exception {
        Transfer transfer = new Transfer();
        transfer.setAddress(address);
        transfer.setMainCoinType(mainCoinType);
        transfer.setCoinType(subCoinType);
