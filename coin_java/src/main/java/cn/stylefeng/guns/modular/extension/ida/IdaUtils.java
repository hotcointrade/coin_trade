...
public class IdaUtils
{
     ...
     * @return  收银台地址
     */
    public static String toCashierIndex(CashDto cashDto)
    {
...
//		System.out.println("收银台链接地址为:"+url);
    ...
    //获取签名
    public static String getSign(String pickupUrl,String receiveUrl,String signType,String orderNo,String coinsNum,String orderCurrency,String customerId,String sign){
