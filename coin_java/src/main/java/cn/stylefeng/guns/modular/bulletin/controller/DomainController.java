...
public class DomainController extends BaseController {
    ...
    private static String PREFIX = "/modular/bulletin/domain_config/";
    ...
    @RequestMapping("")
    public String index() {
        return PREFIX + "domain_config.html";
    }
    ...
    public String configAdd() {
        return PREFIX + "domain_config_add.html";
    }
    ...
    public String configEdit(Long configId, Model model) {
        ...
        return PREFIX+"domain_config_edit.html";
    }
    ...
    public Object list(@RequestParam(required = false) String condition) {
        ...
        //根据条件查询
        Page<Map<String, Object>> result = configService.selectByConditionDomain(condition);
