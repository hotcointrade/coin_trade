...
public class EmailController extends BaseController {
    ...
    @RequestMapping("")
    public String index() {
        return PREFIX + "email_config.html";
    }
    ...
    public String configAdd() {
        return PREFIX + "email_config_add.html";
    }
    ...
    public String configEdit(Long configId, Model model) {
        ...
        return PREFIX+"email_config_edit.html";
    }
    ...
    public Object list(@RequestParam(required = false) String condition) {
        ...
        //根据条件查询
        Page<Map<String, Object>> result = configService.selectByConditionEmail(condition);
