...
public class LeverageController extends BaseController {

    private String PREFIX = "/modular/e/leverage/";
    ...
    public String leverageEdit(Long leverageId, Model model) {
        Leverage condition = this.leverageService.getById(leverageId);
    ...
    public Object detail(@PathVariable("leverageId") Long leverageId) {
        Leverage entity = leverageService.getById(leverageId);
    ...
    @ResponseBody
    public ResponseData edit(Leverage leverage) {
    ...
    @ResponseBody
    public ResponseData add(Leverage leverage, BindingResult result) {
        if (result.hasErrors()) {
    ...
    public Object content(@PathVariable("leverageId") Long id) {
        Leverage leverage = leverageService.getById(id);
