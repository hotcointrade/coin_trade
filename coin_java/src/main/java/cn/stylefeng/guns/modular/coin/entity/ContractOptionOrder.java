...
public class ContractOptionOrder implements Serializable {
    ...
    private Integer back; // 当result为2 时才能back 0或空为没赔付，1为已赔付
    ...
    private String orRecord;//Y 表示已返佣，N 表示没返佣
    private BigDecimal recordNum;//返佣金额
    private String orTowRecord;//Y 表示已返佣，N 表示没返佣
    private BigDecimal recordTowNum;//返佣金额
    private String secondsYield; // 结算周期、收益比例
