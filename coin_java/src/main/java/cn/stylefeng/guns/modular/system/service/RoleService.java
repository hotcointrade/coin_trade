...
public class RoleService extends ServiceImpl<RoleMapper, Role> {
     ...
     * 获取角色列表树
     */
    public List<ZTreeNode> roleTreeList(Long memberId,List<Long> otherRoleId) {
        return this.baseMapper.roleTreeList(memberId,otherRoleId);
    }

    /**
     * 获取角色列表树
     */
    public List<ZTreeNode> roleTreeListByRoleId(String[] roleId,Long memberId,List<Long> otherRoleId) {
        return this.baseMapper.roleTreeListByRoleId(roleId,memberId,otherRoleId);
    }
