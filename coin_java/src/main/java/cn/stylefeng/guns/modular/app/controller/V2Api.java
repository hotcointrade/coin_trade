...
//    @PostMapping("tradeCancelAppeal")
    ...
    @RequestMapping("uploadBuyProof")
    public Result uploadBuyProof(@RequestHeader("token") String token,@RequestParam String billNo,@RequestParam String img) {
        return otcService.uploadBuyProof(token,billNo,img);
    }
