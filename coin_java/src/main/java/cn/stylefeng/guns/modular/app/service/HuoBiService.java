...
//	 * @return
//	 */
//	public DetailResponse<Detail> getDetail(String symbol) {
//		return getApiClient().detail(symbol);
//	}
//
//	/**
//	 * 最近24小时行情数据-合约
...
//	 * @return
//	 */
//	public DetailResponse<Detail> getDetailForContract(String symbol) {
//		return getApiClientSwap().detail(symbol);
//	}
//
//
//	/**
...
//	 * 永续行情
//	 */
//	public DepthResponse swapDepth(String symbol, String type) {
//		return getApiClientSwap().swapDepth(symbol,type);
//	}
//
//	/**
//	 * 永续行情
//	 */
//	public DepthResponse<Depth> spotDepth(String symbol, String type) {
//		return getApiClient().spotDepth(symbol,type);
//	}
//
//
//
...
//		KlineResponse bchusdt = getApiClientSwap().klineSwapEx("BCH-USD", "1day", "20");
//		System.out.println(bchusdt);
//	}
...
////        System.getProperties().put("http.proxyPort", Integer.toString(proxyPort));
