...
public interface MemberMapper extends BaseMapper<Member> {
    ...
    List<Member> selectLevel12(@Param("memberId") Long memberId);
    ...
    Page<Map<String, Object>> selectByConditionUid(@Param("page") Page page,
                                                    @Param("condition") String condition,
                                                    @Param("refereeId")Long refereeId,
                                                    @Param("memberId")Long memberId,
                                                    @Param("recommendIds")String recommendIds,@Param("uid") String uid);
