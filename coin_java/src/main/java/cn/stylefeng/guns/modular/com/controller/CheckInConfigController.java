 ...
 */
@Controller
@RequestMapping("/check_in_config")
public class CheckInConfigController extends BaseController {

    private static String PREFIX = "/modular/com/checkIn/";
    ...
    public Object list(@RequestParam(required = false) String condition) {
        //根据条件查询
        Page<Map<String, Object>> result = configService.selectByConditionCheckIn(condition);
