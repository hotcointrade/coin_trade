 ...
 */
@Controller
@RequestMapping("/sms_config")
public class SmsController extends BaseController {

    private static String PREFIX = "/modular/bulletin/sys_config/";
    ...
    public String configAdd() {
        return PREFIX + "sys_config_add.html";
    }
    ...
    public String configEdit(Long configId, Model model) {
        ...
        return PREFIX+"sys_config_edit.html";
    }
    ...
    public Object list(@RequestParam(required = false) String condition) {
        ...
        //根据条件查询
        Page<Map<String, Object>> result = configService.selectByConditionSms(condition);
